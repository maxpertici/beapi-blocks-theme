...
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"bottom"}} -->
...
<p class="has-text-align-left has-text-align-center is-style-default has-text-800-color has-text-color" style="padding-left:28px"><?php esc_html_e( 'Event dates', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-left has-text-align-center has-text-800-color has-text-color" style="padding-left:28px"><?php esc_html_e( 'Event times', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
...
<p class="has-text-align-left has-text-align-center is-style-default has-text-800-color has-text-color" style="padding-left:28px"><?php esc_html_e( 'Event location', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
<div class="wp-block-group"><!-- wp:beapi/icon-block {"collection":{"name":"icon-theme","label":"Theme","count":3},"icon":{"name":"icon-euro","label":"euro","type":"sprite"},"url":"<?php echo esc_url( $icons_uri ); ?>sprite.svg#icon-euro","size":24} -->
<div class="wp-block-beapi-icon-block"><div class="icon-container" style="border-radius:0%;display:inline-block;padding:0px 0px 0px 0px"><svg class="icon icon-euro" style="width:24px;height:24px" focusable="false" aria-hidden="true"><use href="<?php echo esc_url( $icons_uri ); ?>sprite.svg#icon-euro"></use></svg></div></div>
<!-- /wp:beapi/icon-block -->

<!-- wp:paragraph {"className":"is-style-label"} -->
<p class="is-style-label"><?php esc_html_e( 'Price', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:paragraph {"align":"left","className":"is-style-default","style":{"spacing":{"padding":{"left":"28px"}}}} -->
<p class="has-text-align-left is-style-default" style="padding-left:28px"><?php esc_html_e( 'xxx euros', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-group wp-pattern-hidden-hero-single-event__buttons" style="margin-top:var(--wp--preset--spacing--l)"><!-- wp:buttons {"layout":{"type":"flex","justifyContent":"left"}} -->
...
<div class="wp-block-button is-style-primary-md"><a class="wp-block-button__link wp-element-button" href="#" target="_blank" rel="noreferrer noopener nofollow"><?php esc_html_e( 'Registration link', 'beapi-blocks-theme' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:44.4%"><!-- wp:post-featured-image {"aspectRatio":"2/3"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></header>
<!-- /wp:group -->