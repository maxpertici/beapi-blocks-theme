...
<!-- wp:group {"className":"event__meta","style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group event__meta"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left","verticalAlignment":"bottom"}} -->
...
<!-- wp:group {"className":"event__meta","style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<div class="wp-block-group event__meta"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
