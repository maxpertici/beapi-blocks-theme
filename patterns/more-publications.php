 ...
 * Slug: beapi-blocks-theme/more-publications
 * Description: Displays a list of publications with title and date.
 * Categories: query
...
<section class="wp-block-group wp-pattern-more-publications alignwide" style="margin-top:var(--wp--preset--spacing--4-xl);margin-bottom:var(--wp--preset--spacing--4-xl)">
	...
	<div class="wp-block-columns alignfull are-vertically-aligned-bottom" style="margin-bottom:var(--wp--preset--spacing--l)">
		...
		<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:33.33%">
			...
			<div class="wp-block-buttons">
				<!-- wp:button -->
				<div class="wp-block-button is-style-link"><a class="wp-block-button__link wp-element-button" href="<?php echo esc_url( get_post_type_archive_link( 'publication' ) ); ?>"><?php esc_html_e( 'See more posts', 'beapi-blocks-theme' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
	...
	<!-- wp:query {"query":{"perPage":3,"pages":0,"offset":0,"postType":"publication","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false,"taxQuery":null,"parents":[]},"align":"full","layout":{"type":"default"}} -->
	<div class="wp-block-query alignfull">
		<!-- wp:post-template {"align":"full","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"19rem"}} -->
