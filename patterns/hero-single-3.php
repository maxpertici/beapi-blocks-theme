...
/**
 * Title: Hero single 3
 * Slug: beapi-blocks-theme/hero-single-3
 * Inserter: no
 *
 * @package WordPress
...
?>
<!-- wp:group {"tagName":"header","align":"wide","className":"wp-pattern-hero-single wp-pattern-hero-single-3","style":{"spacing":{"margin":{"top":"var:preset|spacing|xl","bottom":"var:preset|spacing|2-xl"}}},"layout":{"type":"constrained"}} -->
<header class="wp-block-group alignwide wp-pattern-hero-single wp-pattern-hero-single-3" style="margin-top:var(--wp--preset--spacing--xl);margin-bottom:var(--wp--preset--spacing--2-xl)">
