...
<header class="wp-block-group alignwide wp-pattern-hidden-hero-single-event wp-pattern-hidden-hero-single-event-1" style="margin-bottom:var(--wp--preset--spacing--3-xl)">
	...
	<div class="wp-block-columns alignwide wp-pattern-hidden-hero-single-event__metas">
		<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}}} -->
		<div class="wp-block-column">
			<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
			...
			<p class="has-text-align-center is-style-h6">
	...
	<div class="wp-block-group wp-pattern-hidden-hero-single-event__buttons">
	...
	<!-- wp:post-excerpt {"excerptLength":10000,"className":"is-style-default","style":{"spacing":{"padding":{"top":"0","bottom":"0"},"margin":{"bottom":"var:preset|spacing|xl"}}},"fontSize":"large"} /-->
</header>
<!-- /wp:group -->
