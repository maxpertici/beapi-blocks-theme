...
<div class="wp-block-columns alignwide wp-pattern-hidden-hero-single-event__metas"><!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}}} -->
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
...
<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}}} -->
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|3-xs"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
...
<!-- wp:paragraph {"align":"center","className":"is-style-h6"} -->
<p class="has-text-align-center is-style-h6"><?php esc_html_e( 'xxx euros', 'beapi-blocks-theme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
